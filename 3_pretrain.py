...
#from model_segmamba.pretrain.dataset.brats import get_datasets_train_rf_forpretrain, get_datasets_brats20_rf
from light_training.dataloading.dataset import get_train_val_test_loader_from_train
#from model_segmamba.pretrain.loss import EDiceLoss
#from model_segmamba.pretrain.loss.dice import EDiceLoss_Val
from model_segmamba.pretrain.utils import AverageMeter, ProgressMeter, save_checkpoint, \
    count_parameters, save_args_1
...
parser.add_argument('--dataset', type=str, default='brats18', choices=['brats18', 'brats20', 'brats22'])
...
def main(args):
    ...
    if args.dataset == "brats22":
        train_loader, val_loader, test_ds = get_train_val_test_loader_from_train(data_dir)
